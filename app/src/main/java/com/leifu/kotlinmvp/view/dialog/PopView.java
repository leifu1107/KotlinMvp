package com.leifu.kotlinmvp.view.dialog;

/**
 * 创建人:雷富
 * 创建时间:2019/6/26 15:54
 * 描述:
 */
...
public class PopView implements PopupWindow.OnDismissListener{
    ...
    private PopView(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public PopView showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public PopView showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public PopView showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public PopView showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
            ...
            mPopupWindow.setTouchInterceptor(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if ((event.getAction() == MotionEvent.ACTION_DOWN)
                        ...
                        Log.e(TAG,"out side ");
                        Log.e(TAG,"out side ..."+"width:"+mWidth+"height:"+mHeight);
    ...
    public static class PopupWindowBuilder{
        private PopView mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new PopView(context);
        }
